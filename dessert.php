...
<head>
    ...
    <link href="css/styledessert.css" rel="stylesheet" type="text/css">
...
<body>
    <div class="wrap">
        ...
        <div class ="top"><img src="picture\dessertbanner2.png" ></div>
        ...
        <div class="menu">
            <ul>
                <li>
                    <div class="type">
                        <div class="menupicture"><img src="picture\dessertmenu.png" height="230" width="150px"></div>
        ...
        <div class="recipelist">
            ...
            <?php 
                include "db_conn.php";
                $sql = "SELECT * FROM dish WHERE dish_type LIKE '%甜點%'";
