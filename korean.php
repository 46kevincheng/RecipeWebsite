...
<head>
    ...
    <link href="css/styleKorea.css" rel="stylesheet" type="text/css">
...
<body>
    <div class="wrap">
        ...
        <div class ="top"><img src="picture\koreanbanner.png" ></div>
        ...
        <div class="menu">
            <ul>
                <li>
                    <div class="type">
                        <div class="menupicture"><img src="picture\koreamenu.png" height="230" width="150px"></div>
        ...
        <div class="recipelist">
            ...
            <?php 
                include "db_conn.php";
                $sql = "SELECT * FROM dish WHERE dish_type LIKE '%韓式料理%'";
