...
<body>
    <div class="wrap">
        ...
        <div class ="top"><img src="picture\japanesebanner.png" ></div>
        ...
        <div class="menu">
            <ul>
                <li>
                    <div class="type">
                        <div class="menupicture"><img src="picture\menu.png" height="200" width="100px"></div>
                        <a href="#">日式料理</a>
                    </div>
                </li>
            </ul>
        ...
        <div class="recipelist">
            ...
            <?php 
                include "db_conn.php";
                $sql = "SELECT * FROM dish WHERE dish_type LIKE '%日式料理%'";
