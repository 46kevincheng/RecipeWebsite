...
<head>
    ...
    <link href="css/styleChinese.css" rel="stylesheet" type="text/css">
...
<body>
    <div class="wrap">
        ...
        <div class ="top"><img src="picture\taiwanesebanner.png" ></div>
        ...
        <div class="chinesemenu">
            <ul>
                <li>
                    <div class="type">
                        <div class="menupicture"><img src="picture\chinesemenu.png" height="200" width="150px"></div>
        ...
        <div class="recipelist">
            ...
            <?php 
                include "db_conn.php";
                $sql = "SELECT * FROM dish WHERE dish_type LIKE '%中式料理%'";
