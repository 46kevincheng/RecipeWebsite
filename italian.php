...
<head>
    ...
    <link href="css/styleItaly.css" rel="stylesheet" type="text/css">
...
<body>
    <div class="wrap">
        ...
        <div class ="top"><img src="picture\italianbanner.png" ></div>
        ...
        <div class="menu">
            <ul>
                <li>
                    <div class="type">
                        <div class="menupicture"><img src="picture\italymenu.png" height="200" width="150px"></div>
        ...
        <div class="recipelist">
            ...
            <?php 
                include "db_conn.php";
                $sql = "SELECT * FROM dish WHERE dish_type LIKE '%義式料理%'";
