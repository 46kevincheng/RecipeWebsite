...
<head>
    ...
    <link href="css/styleAmerica.css" rel="stylesheet" type="text/css">
...
<body>
    <div class="wrap">
        ...
        <div class ="top"><img src="picture\americanbanner.png" ></div>
        ...
        <div class="menu">
            <ul>
                <li>
                    <div class="type">
                        <div class="menupicture"><img src="picture\americanmenu.png" height="220" width="140px"></div>
        ...
        <div class="recipelist">
            ...
            <?php 
                include "db_conn.php";
                $sql = "SELECT * FROM dish WHERE dish_type LIKE '%美式料理%'";
